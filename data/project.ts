export const projects: Project[] = [
  ...
  },
  {
    title: '社团主页',
    description: '做引导页~',
    preview: 'https://www.gwy.fun/img/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20231216233656.png',
    website: 'https://syfbc.gwy.fun/',
    tags: ['favorite'],
    type: 'web',
  },
  {
    title: '说说icrystal',
    description: '集成作品在线试听、下载、同人作品等功能',
    preview: 'https://www.gwy.fun/img/DF55A3D0A70246EBA449D11649377416.png',
    website: 'https://icrystal.gwy.fun/',
    tags: ['favorite'],
    type: 'web',
  },
  {
  ...
  },
  {
    title: '社团点歌系统',
    description: '魔改问卷系统',
    preview: 'https://www.gwy.fun/img/shetu.png',
